...
const Booking = () => {
  return (
    <div className='relative flex flex-col max-w-[1120px] justify-self-center w-full shadow-lg p-5 gap-5 bg-white z-2'>
      ...
      <div className='flex flex-col gap-1'>
        ...
        <input type="text" className='border border-gray-300 rounded-lg p-2 w-full' placeholder='Enter departure airport or city' />
      </div>
      <div className='flex flex-col gap-1'>
        <label className='text-gray-700'>To</label>
        <input type="text" className='border border-gray-300 rounded-lg p-2 w-full' placeholder='Enter arrival airport or city' />
      </div>
